  ...
  return (
    <main className="min-h-screen flex flex-col bg-background text-foreground items-center justify-center">
      ...
      <div className="text-center">
        <h2 className="text-4xl sm:text-6xl font-bold font-display mb-4">404</h2>
        <p className="text-base sm:text-xl text-muted mb-8">Could not find requested resource</p>
